...
const tf = require("@tensorflow/tfjs-node");  //cambio
...
/**
 * Inicializa backend TensorFlow y carga el GraphModel
 */
async function initModel() {
  await tf.setBackend("tensorflow");   //cambio
  await tf.ready();
  console.log("[TF] Backend:", tf.getBackend());

  const modelPath = `file://${path.resolve(__dirname, "../model/model.json")}`;  //cambio
  console.log("[TF] Cargando modelo:", modelPath);
